...
if (authServiceLocation) {
  ...
  else authModule = authServiceLocation;

  authService = new require('./' + authModule + '/index.js')(settings);
  if (authService && 'true' == process.env.enableHystrix) {
    // wrap into command pattern
