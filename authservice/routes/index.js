...
module.exports = function(dbtype, settings) {
  ...
  module.createSessionInDB = function(
    customerId,
    ...
    dataaccess.insertOne(module.dbNames.customerSessionName, document, function(
      error,
      doc
    ) {
  ...
  module.validateSessionInDB = function(
    sessionId,
    callback /* (error, session) */
  ) {
    ...
    dataaccess.findOne(module.dbNames.customerSessionName, sessionId, function(
      err,
      session
    ) {
