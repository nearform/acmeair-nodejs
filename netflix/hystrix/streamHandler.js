...
StreamHandler.prototype.getJsonMessageAsString = function(
  callback /*err,jsonMessageStr*/
) {
  var sb = '';
  for (var i in this.data) sb += 'data: ' + this.data[i] + '\n\n';
    ...
    item.getStatistics(function(error, result) {
      if (error) console.log(error);
        ...
        json.propertyValue_circuitBreakerSleepWindowInMilliseconds =
          circuitBreaker == null ? 0 : circuitBreaker.resetTimeout;
        ...
        json.propertyValue_executionIsolationThreadTimeoutInMilliseconds =
          circuitBreaker == null ? 0 : circuitBreaker.callTimeout;
        ...
        json.propertyValue_metricsRollingStatisticalWindowInMilliseconds =
          metrix.rollingStatisticalWindowInMilliseconds;
